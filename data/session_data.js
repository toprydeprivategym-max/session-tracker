...
// === 2026年7月（2026-07-12 自動更新 / job id=213506 = 最新の成功エクスポート(7/11 09:03 JST) / 予約中+受講済み＝当月進行中のため予定含む / 対象8名） ===
// 集計（対象8名・予約中+受講済み）: 30分:440 / 60分:563 / 合計:1003
// 整合性: 対象8名 分類1107 + 担当者空欄17 + カウンセリング11 = 1135行 = CSVデータ行数 ✓
// 【注記】2026-07-12実行時、GYMSのCSVジョブワーカーが停止中（新規ジョブが status=before のまま処理されず）のため、
//         最新の成功エクスポート job 213506 で再集計。前回(7/11)は公開フォルダのみ旧job 213379の値(鵜飼60分=91)が残っていたため是正。
SESSION_DATA[2026] = SESSION_DATA[2026] || {};
SESSION_DATA[2026][7] = {
  "パーソナルジムTop Ryde 川西能勢口ANNEX店": { "鵜飼晃": { s30: 86, s60: 92 } },
