...
// === 2026年7月（2026-07-15 自動更新 / job id=219769 = 当月フルエクスポート(7/15 09:15 JST) / 予約中+受講済み＝当月進行中のため予定含む） ===
// 集計(対象8名): 30分:455 / 60分:568 / 合計:1023
// 整合性: 対象8名1146 + 対象外担当28 + カウンセリング13 = 1187行 = CSVデータ行数 ✓
SESSION_DATA[2026] = SESSION_DATA[2026] || {};
SESSION_DATA[2026][7] = {
  "パーソナルジムTop Ryde 川西能勢口ANNEX店": { "鵜飼晃": { s30: 85, s60: 91 } },
  "パーソナルジムTop Ryde 川西能勢口店": { "空中泰樹": { s30: 4, s60: 19 } },
  "パーソナルジムTop Ryde 阪急池田店": { "島村卓也": { s30: 0, s60: 0 }, "田口美紀": { s30: 14, s60: 70 } },
  "パーソナルジムTop Ryde 茨木市駅前店": { "矢野利佳": { s30: 50, s60: 132 } },
  "パーソナルジムTop Ryde 阪神西宮店": { "芦田崚馬": { s30: 35, s60: 83 } },
  "ファーストピラティス池田店": { "壹岐和恵": { s30: 123, s60: 75 } },
...
// 2026-07-15 更新（6月受講済み顧客のうち7月に受講済み/予約中がある顧客 / job 219769,219770・値は前回と一致）
...
// 2026-07-15 更新（job 219769 / 7月確定分・カウンセリング除く）
RATE_DATA[2026][7] = {
  "鵜飼晃":{done:72,daycxl:5,cxl:1}, "空中泰樹":{done:9,daycxl:0,cxl:8}, "田口美紀":{done:38,daycxl:0,cxl:19}, "矢野利佳":{done:76,daycxl:1,cxl:16},
  "芦田崚馬":{done:53,daycxl:3,cxl:6}, "壹岐和恵":{done:77,daycxl:1,cxl:27}, "屋宜広紀":{done:48,daycxl:0,cxl:5}, "長濱心花音":{done:59,daycxl:0,cxl:31}
};
...
// 2026-07-15 更新（job 219769 / 実施=受講済み 7月分）
UTIL_DATA[2026][7] = {
  "鵜飼晃":{hours:54.5,workdays:12}, "空中泰樹":{hours:9,workdays:6}, "田口美紀":{hours:34.5,workdays:11}, "矢野利佳":{hours:66,workdays:11},
  "芦田崚馬":{hours:43.5,workdays:11}, "壹岐和恵":{hours:51.5,workdays:9}, "屋宜広紀":{hours:37,workdays:13}, "長濱心花音":{hours:41.5,workdays:10}
};
