...
// === 2026年7月（2026-07-13 自動更新 / job id=217585 = 当月フルエクスポート(7/13 09:13 JST) / 予約中+受講済み＝当月進行中のため予定含む） ===
// 集計: 30分:452 / 60分:565 / 合計:1017
// 整合性: 分類1017 + 担当者空欄20 + キャンセル113 + カウンセリング12 = 1162行 = CSVデータ行数 ✓
SESSION_DATA[2026] = SESSION_DATA[2026] || {};
SESSION_DATA[2026][7] = {
  "パーソナルジムTop Ryde 川西能勢口ANNEX店": { "鵜飼晃": { s30: 85, s60: 92 } },
  "パーソナルジムTop Ryde 川西能勢口店": { "空中泰樹": { s30: 4, s60: 18 } },
  "パーソナルジムTop Ryde 阪急池田店": { "田口美紀": { s30: 14, s60: 71 } },
  "パーソナルジムTop Ryde 茨木市駅前店": { "矢野利佳": { s30: 50, s60: 133 } },
  "パーソナルジムTop Ryde 阪神西宮店": { "芦田崚馬": { s30: 35, s60: 83 } },
  "ファーストピラティス池田店": { "壹岐和恵": { s30: 123, s60: 71 } },
  "ファーストピラティス茨木市駅前店": { "屋宜広紀": { s30: 45, s60: 52 } },
...
// 2026-07-13 更新（6月受講済み顧客のうち7月に受講済み/予約中がある顧客 / job 217585,217586）
...
// 2026-07-13 更新（job 217585 / 7/1〜7/13の確定分）
RATE_DATA[2026][7] = {
  "鵜飼晃":{done:69,daycxl:4,cxl:1}, "空中泰樹":{done:7,daycxl:0,cxl:7}, "田口美紀":{done:34,daycxl:0,cxl:17}, "矢野利佳":{done:67,daycxl:0,cxl:16},
  "芦田崚馬":{done:45,daycxl:3,cxl:6}, "壹岐和恵":{done:63,daycxl:1,cxl:23}, "屋宜広紀":{done:38,daycxl:0,cxl:5}, "長濱心花音":{done:41,daycxl:0,cxl:30}
};
...
// 2026-07-13 更新（job 217585 / 実施=受講済み 7/1〜7/13分）
UTIL_DATA[2026][7] = {
  "鵜飼晃":{hours:52,workdays:11}, "空中泰樹":{hours:7,workdays:5}, "田口美紀":{hours:31.5,workdays:10}, "矢野利佳":{hours:59,workdays:10},
  "芦田崚馬":{hours:37.5,workdays:9}, "壹岐和恵":{hours:42.5,workdays:7}, "屋宜広紀":{hours:29,workdays:11}, "長濱心花音":{hours:30,workdays:8}
};
