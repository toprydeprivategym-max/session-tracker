...
// === 2026年7月（2026-07-18 自動更新 / job id=223367 = 当月フルエクスポート(7/18 17:31 JST・1220行) / 対象8名・予約中+受講済み＝当月進行中のため予定含む） ===
// 集計(対象8名・空中泰樹含む/島村卓也除外): 30分:455 / 60分:573 / 合計:1028（うち受講済みのみ529・7名なら518）
// 整合性: 対象8名1028 + 対象キャンセル類139 + 対象外担当33 + カウンセリング20 = 1220行 = CSVデータ行数 ✓
SESSION_DATA[2026] = SESSION_DATA[2026] || {};
SESSION_DATA[2026][7] = {
...
// 2026-07-18 更新（6月受講済み顧客のうち7月に受講済み/予約中がある顧客 / job 223367,221923）
...
// 2026-07-18 更新（job 223367 / 7月確定分・カウンセリング除く）
RATE_DATA[2026][7] = {
  "鵜飼晃":{done:94,daycxl:8,cxl:3}, "空中泰樹":{done:11,daycxl:0,cxl:8}, "田口美紀":{done:51,daycxl:1,cxl:20}, "矢野利佳":{done:93,daycxl:2,cxl:17},
  "芦田崚馬":{done:66,daycxl:3,cxl:8}, "壹岐和恵":{done:92,daycxl:1,cxl:30}, "屋宜広紀":{done:52,daycxl:0,cxl:5}, "長濱心花音":{done:70,daycxl:0,cxl:33}
};
...
// 2026-07-18 更新（job 223367 / 実施=受講済み 7月分）
UTIL_DATA[2026][7] = {
  "鵜飼晃":{hours:71.5,workdays:15}, "空中泰樹":{hours:11,workdays:7}, "田口美紀":{hours:45.5,workdays:14}, "矢野利佳":{hours:82,workdays:14},
  "芦田崚馬":{hours:55,workdays:14}, "壹岐和恵":{hours:62,workdays:11}, "屋宜広紀":{hours:41,workdays:15}, "長濱心花音":{hours:48,workdays:12}
};
