...
// === 2026年7月（2026-07-01 自動更新 / job id=199797 / 受講済みのみ集計＝GYMS実績基準 / 対象7名） ===
// 集計（対象7名・受講済みのみ）: 30分:0 / 60分:0 / 合計:0 ※月初(7/1)時点で実施済みセッションなし。当月CSVは予約中865件・キャンセル49件。
// 整合性: 受講済み0 + 受講済み対象外0 + カウンセリング6 + 未実施(予約中860+キャンセル48+当日0)=908 = 914行 = CSVデータ行数 ✓
SESSION_DATA[2026] = SESSION_DATA[2026] || {};
SESSION_DATA[2026][7] = {
  "パーソナルジムTop Ryde 川西能勢口ANNEX店": { "鵜飼晃": { s30: 0, s60: 0 } },
  "パーソナルジムTop Ryde 阪急池田店": { "田口美紀": { s30: 0, s60: 0 } },
  "パーソナルジムTop Ryde 茨木市駅前店": { "矢野利佳": { s30: 0, s60: 0 } },
  "パーソナルジムTop Ryde 阪神西宮店": { "芦田崚馬": { s30: 0, s60: 0 } },
  "ファーストピラティス池田店": { "壹岐和恵": { s30: 0, s60: 0 } },
  "ファーストピラティス茨木市駅前店": { "屋宜広紀": { s30: 0, s60: 0 } },
  "ファーストピラティス中百舌鳥店": { "長濱心花音": { s30: 0, s60: 0 } }
};
