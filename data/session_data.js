...
// === 2026年7月（2026-07-04 自動更新 / job id=203243 / 予約中+受講済み＝当月進行中のため予定含む / 対象8名） ===
// 集計（対象8名）: 30分:424 / 60分:523 / 合計:947（内訳: 受講済み48・予約中899）
// 整合性: 対象(予約中+受講済み)947 + 受講済み対象外3 + カウンセリング9 + キャンセル66 + 当日キャンセル3 = 1028行 = CSVデータ行数 ✓
// 【注記】島村卓也は当月0本のため記載なし。
SESSION_DATA[2026] = SESSION_DATA[2026] || {};
SESSION_DATA[2026][7] = {
  "パーソナルジムTop Ryde 川西能勢口ANNEX店": { "鵜飼晃": { s30: 76, s60: 71 } },
  "パーソナルジムTop Ryde 川西能勢口店": { "空中泰樹": { s30: 4, s60: 15 } },
  "パーソナルジムTop Ryde 阪急池田店": { "田口美紀": { s30: 12, s60: 68 } },
  "パーソナルジムTop Ryde 茨木市駅前店": { "矢野利佳": { s30: 47, s60: 135 } },
  "パーソナルジムTop Ryde 阪神西宮店": { "芦田崚馬": { s30: 32, s60: 79 } },
  "ファーストピラティス池田店": { "壹岐和恵": { s30: 114, s60: 65 } },
  "ファーストピラティス茨木市駅前店": { "屋宜広紀": { s30: 41, s60: 45 } },
...
// 2026-07-04 更新（7月暫定: 6月受講済み顧客のうち7月に受講済み/予約中がある顧客。月進行中のため後続実行で更新 / job 203243,203244）
RETENTION_DATA[2026][7] = {
  "鵜飼晃":{num:31,den:38}, "空中泰樹":{num:5,den:6}, "田口美紀":{num:19,den:25}, "矢野利佳":{num:41,den:43},
  "芦田崚馬":{num:25,den:29}, "壹岐和恵":{num:39,den:44}, "屋宜広紀":{num:18,den:22}, "長濱心花音":{num:30,den:31}
};
var CONVERSION_DATA = {
...
// 2026-07-04 更新（job 203243 / 7/1〜7/3の確定分のみ・暫定）
RATE_DATA[2026][7] = {
  "鵜飼晃":{done:13,daycxl:0,cxl:0}, "空中泰樹":{done:1,daycxl:0,cxl:5}, "田口美紀":{done:8,daycxl:0,cxl:7}, "矢野利佳":{done:5,daycxl:0,cxl:12},
  "芦田崚馬":{done:5,daycxl:3,cxl:5}, "壹岐和恵":{done:9,daycxl:0,cxl:14}, "屋宜広紀":{done:1,daycxl:0,cxl:1}, "長濱心花音":{done:6,daycxl:0,cxl:21}
};
...
// 2026-07-04 更新（job 203243 / 実施=受講済み 7/1〜7/2分・暫定）
UTIL_DATA[2026][7] = {
