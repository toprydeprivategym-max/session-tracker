...
// === 2026年7月（2026-07-03 自動更新 / job id=202186 / 予約中+受講済み＝当月進行中のため予定含む / 対象8名） ===
// 集計（対象8名）: 30分:421 / 60分:493 / 合計:914（内訳: 受講済み48・予約中866）
// 整合性: 対象(予約中+受講済み)914 + 受講済み対象外3 + カウンセリング9 + キャンセル61 + 当日キャンセル3 = 990行 = CSVデータ行数 ✓
SESSION_DATA[2026] = SESSION_DATA[2026] || {};
SESSION_DATA[2026][7] = {
  "パーソナルジムTop Ryde 川西能勢口ANNEX店": { "鵜飼晃": { s30: 76, s60: 67 } },
  "パーソナルジムTop Ryde 川西能勢口店": { "空中泰樹": { s30: 4, s60: 15 } },
  "パーソナルジムTop Ryde 阪急池田店": { "田口美紀": { s30: 12, s60: 69 } },
  "パーソナルジムTop Ryde 茨木市駅前店": { "矢野利佳": { s30: 48, s60: 128 } },
  "パーソナルジムTop Ryde 阪神西宮店": { "芦田崚馬": { s30: 32, s60: 75 } },
  "ファーストピラティス池田店": { "壹岐和恵": { s30: 114, s60: 65 } },
  "ファーストピラティス茨木市駅前店": { "屋宜広紀": { s30: 37, s60: 33 } },
  "ファーストピラティス中百舌鳥店": { "長濱心花音": { s30: 98, s60: 41 } }
};
...
// 2026-07-03 追加（7月暫定: 6月受講済み顧客のうち7月に受講済み/予約中がある顧客。月進行中のため後続実行で更新）
RETENTION_DATA[2026][7] = {
  "鵜飼晃":{num:30,den:38}, "空中泰樹":{num:5,den:6}, "田口美紀":{num:19,den:25}, "矢野利佳":{num:40,den:43},
  "芦田崚馬":{num:25,den:29}, "壹岐和恵":{num:39,den:44}, "屋宜広紀":{num:15,den:22}, "長濱心花音":{num:30,den:31}
};
var CONVERSION_DATA = {
...
// 2026-07-03 追加（job 202186 / 7/1〜7/2の確定分のみ・暫定）
RATE_DATA[2026][7] = {
  "鵜飼晃":{done:13,daycxl:0,cxl:0}, "空中泰樹":{done:1,daycxl:0,cxl:5}, "田口美紀":{done:8,daycxl:0,cxl:6}, "矢野利佳":{done:5,daycxl:0,cxl:11},
  "芦田崚馬":{done:5,daycxl:3,cxl:5}, "壹岐和恵":{done:9,daycxl:0,cxl:12}, "屋宜広紀":{done:1,daycxl:0,cxl:1}, "長濱心花音":{done:6,daycxl:0,cxl:20}
};
...
// 2026-07-03 追加（job 202186 / 実施=受講済み 7/1〜7/2分・暫定）
UTIL_DATA[2026][7] = {
  "鵜飼晃":{hours:8.5,workdays:2}, "空中泰樹":{hours:1,workdays:1}, "田口美紀":{hours:7,workdays:2}, "矢野利佳":{hours:5,workdays:1},
  "芦田崚馬":{hours:3.5,workdays:2}, "壹岐和恵":{hours:6,workdays:1}, "屋宜広紀":{hours:1,workdays:1}, "長濱心花音":{hours:5.5,workdays:2}
};
