...
// === 2026年6月（2026-06-28 全量更新 / job id=196892（当月）+196893（前月5月・継続率突合）） ===
// 集計（対象8名）: 30分:466 / 60分:530 / 合計:996
// 【除外】キャンセル:151件（当日23含む / 通常128 / カウンセリング除く） / カウンセリング:32件（全社）
//   対象外スタッフ:54件（正規化スタッフ名が対象8名に不一致 / 担当者空欄・自主トレ等）
//   整合性: 分類996 + 対象外54 + キャンセル151 + カウンセリング32 = 1233行 = CSVデータ行数 ✓
// 【注記】月末28日時点の集計（予約中107件＝月末までの未来分を含む）。term_type=action。
SESSION_DATA[2026] = SESSION_DATA[2026] || {};
SESSION_DATA[2026][6] = {
  "パーソナルジムTop Ryde 川西能勢口ANNEX店": {
    "鵜飼晃": { s30: 83, s60: 72 }
...
// 2026-06-28 更新（job 196892 / 当月確定分）
RATE_DATA[2026][6] = {
  "鵜飼晃":{done:141,daycxl:8,cxl:12}, "空中泰樹":{done:25,daycxl:0,cxl:5}, "田口美紀":{done:86,daycxl:3,cxl:16}, "矢野利佳":{done:165,daycxl:6,cxl:19},
  "芦田崚馬":{done:113,daycxl:4,cxl:6}, "壹岐和恵":{done:165,daycxl:2,cxl:34}, "屋宜広紀":{done:83,daycxl:0,cxl:11}, "長濱心花音":{done:113,daycxl:0,cxl:24}
};
...
// 2026-06-28 更新（job 196892 / 実施=受講済み）
UTIL_DATA[2026][6] = {
  "鵜飼晃":{hours:102,workdays:23}, "空中泰樹":{hours:23,workdays:13}, "田口美紀":{hours:74,workdays:21}, "矢野利佳":{hours:139.5,workdays:21},
  "芦田崚馬":{hours:93.5,workdays:19}, "壹岐和恵":{hours:111,workdays:20}, "屋宜広紀":{hours:61.5,workdays:23}, "長濱心花音":{hours:78,workdays:19}
};
