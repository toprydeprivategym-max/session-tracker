...
// === 2026年7月（2026-07-08 自動更新 / job id=209738 / 予約中+受講済み＝当月進行中のため予定含む / 対象7名・空中泰樹除外） ===
// 集計（対象7名・予約中+受講済み）: 30分:436 / 60分:530 / 合計:966
// 整合性: 対象7名966 + 空中泰樹20(対象外) + 対象外スタッフ6(予約中+受講済み) + カウンセリング11 + キャンセル76 + 当日キャンセル4 = 1083行 = CSVデータ行数 ✓
// 【注記】島村卓也は当月0本（CSVに行なし）。空中泰樹（川西能勢口店・20本）はSESSION_DATA対象外だがRATE/UTIL/RETENTIONには従来どおり計上。
SESSION_DATA[2026] = SESSION_DATA[2026] || {};
SESSION_DATA[2026][7] = {
  "パーソナルジムTop Ryde 川西能勢口ANNEX店": { "鵜飼晃": { s30: 86, s60: 79 } },
  "パーソナルジムTop Ryde 阪急池田店": { "島村卓也": { s30: 0, s60: 0 }, "田口美紀": { s30: 12, s60: 71 } },
  "パーソナルジムTop Ryde 茨木市駅前店": { "矢野利佳": { s30: 49, s60: 135 } },
  "パーソナルジムTop Ryde 阪神西宮店": { "芦田崚馬": { s30: 32, s60: 83 } },
  "ファーストピラティス池田店": { "壹岐和恵": { s30: 117, s60: 70 } },
  "ファーストピラティス茨木市駅前店": { "屋宜広紀": { s30: 43, s60: 47 } },
  "ファーストピラティス中百舌鳥店": { "長濱心花音": { s30: 97, s60: 45 } }
};
...
// 2026-07-08 更新（7月暫定: 6月受講済み顧客のうち7月に受講済み/予約中がある顧客。月進行中のため後続実行で更新 / job 209738,209739）
RETENTION_DATA[2026][7] = {
  "鵜飼晃":{num:34,den:38}, "空中泰樹":{num:5,den:6}, "田口美紀":{num:19,den:25}, "矢野利佳":{num:41,den:43},
  "芦田崚馬":{num:26,den:29}, "壹岐和恵":{num:41,den:44}, "屋宜広紀":{num:18,den:22}, "長濱心花音":{num:30,den:31}
};
var CONVERSION_DATA = {
...
// 2026-07-08 更新（job 209738 / 7/1〜7/7の確定分のみ・暫定）
RATE_DATA[2026][7] = {
  "鵜飼晃":{done:38,daycxl:0,cxl:1}, "空中泰樹":{done:5,daycxl:0,cxl:7}, "田口美紀":{done:17,daycxl:0,cxl:8}, "矢野利佳":{done:34,daycxl:0,cxl:13},
  "芦田崚馬":{done:20,daycxl:3,cxl:6}, "壹岐和恵":{done:25,daycxl:1,cxl:15}, "屋宜広紀":{done:22,daycxl:0,cxl:1}, "長濱心花音":{done:23,daycxl:0,cxl:24}
};
...
// 2026-07-08 更新（job 209738 / 実施=受講済み 7/1〜7/7分・暫定）
UTIL_DATA[2026][7] = {
  "鵜飼晃":{hours:26.5,workdays:6}, "空中泰樹":{hours:5,workdays:4}, "田口美紀":{hours:16,workdays:5}, "矢野利佳":{hours:31,workdays:5},
  "芦田崚馬":{hours:17.5,workdays:5}, "壹岐和恵":{hours:17.5,workdays:3}, "屋宜広紀":{hours:17,workdays:6}, "長濱心花音":{hours:16.5,workdays:5}
};
