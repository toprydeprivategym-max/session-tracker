...
// === 2026年7月（2026-07-07 自動更新 / job id=208453 / 予約中+受講済み＝当月進行中のため予定含む / 対象7名・空中泰樹除外） ===
// 集計（対象7名・予約中+受講済み）: 30分:427 / 60分:522 / 合計:949
// 整合性: 対象7名949 + 空中泰樹20(対象外) + 対象外スタッフ5(受講済み) + カウンセリング11 + キャンセル74 + 当日キャンセル3 = 1062行 = CSVデータ行数 ✓
// 【注記】島村卓也は当月0本（CSVに行なし）。空中泰樹（川西能勢口店・20本）はSESSION_DATA対象外だがRATE/UTIL/RETENTIONには従来どおり計上。
SESSION_DATA[2026] = SESSION_DATA[2026] || {};
SESSION_DATA[2026][7] = {
  "パーソナルジムTop Ryde 川西能勢口ANNEX店": { "鵜飼晃": { s30: 80, s60: 73 } },
  "パーソナルジムTop Ryde 阪急池田店": { "島村卓也": { s30: 0, s60: 0 }, "田口美紀": { s30: 12, s60: 72 } },
  "パーソナルジムTop Ryde 茨木市駅前店": { "矢野利佳": { s30: 47, s60: 135 } },
  "パーソナルジムTop Ryde 阪神西宮店": { "芦田崚馬": { s30: 32, s60: 83 } },
  "ファーストピラティス池田店": { "壹岐和恵": { s30: 116, s60: 69 } },
  "ファーストピラティス茨木市駅前店": { "屋宜広紀": { s30: 43, s60: 45 } },
...
// 2026-07-07 更新（7月暫定: 6月受講済み顧客のうち7月に受講済み/予約中がある顧客。月進行中のため後続実行で更新 / job 208453,208454）
RETENTION_DATA[2026][7] = {
  "鵜飼晃":{num:32,den:38}, "空中泰樹":{num:5,den:6}, "田口美紀":{num:19,den:25}, "矢野利佳":{num:41,den:43},
...
// 2026-07-07 更新（job 208453 / 7/1〜7/6の確定分のみ・暫定）
RATE_DATA[2026][7] = {
  "鵜飼晃":{done:38,daycxl:0,cxl:1}, "空中泰樹":{done:3,daycxl:0,cxl:6}, "田口美紀":{done:17,daycxl:0,cxl:7}, "矢野利佳":{done:25,daycxl:0,cxl:13},
  "芦田崚馬":{done:20,daycxl:3,cxl:6}, "壹岐和恵":{done:14,daycxl:0,cxl:15}, "屋宜広紀":{done:17,daycxl:0,cxl:1}, "長濱心花音":{done:16,daycxl:0,cxl:24}
};
...
// 2026-07-07 更新（job 208453 / 実施=受講済み 7/1〜7/6分・暫定）
UTIL_DATA[2026][7] = {
  "鵜飼晃":{hours:26.5,workdays:6}, "空中泰樹":{hours:3,workdays:3}, "田口美紀":{hours:16,workdays:5}, "矢野利佳":{hours:23.5,workdays:4},
  "芦田崚馬":{hours:17.5,workdays:5}, "壹岐和恵":{hours:9.5,workdays:2}, "屋宜広紀":{hours:13.5,workdays:5}, "長濱心花音":{hours:12,workdays:4}
};
