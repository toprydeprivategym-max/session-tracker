...
// === 2026年7月（2026-07-19 自動更新 / job id=225910 = 当月フルエクスポート(7/19 07:33 JST・1220行) / 対象8名・予約中+受講済み＝当月進行中のため予定含む） ===
// 集計(対象8名・空中泰樹含む/島村卓也除外): 30分:453 / 60分:573 / 合計:1026（うち受講済みのみ563・7名なら551）
// 整合性: 対象8名1026 + キャンセル類144 + 対象外担当30 + カウンセリング20 = 1220行 = CSVデータ行数 ✓
SESSION_DATA[2026] = SESSION_DATA[2026] || {};
SESSION_DATA[2026][7] = {
  "パーソナルジムTop Ryde 川西能勢口ANNEX店": { "鵜飼晃": { s30: 83, s60: 94 } },
  "パーソナルジムTop Ryde 川西能勢口店": { "空中泰樹": { s30: 4, s60: 19 } },
  "パーソナルジムTop Ryde 阪急池田店": { "田口美紀": { s30: 14, s60: 72 } },
  "パーソナルジムTop Ryde 茨木市駅前店": { "矢野利佳": { s30: 50, s60: 132 } },
  "パーソナルジムTop Ryde 阪神西宮店": { "芦田崚馬": { s30: 35, s60: 82 } },
  "ファーストピラティス池田店": { "壹岐和恵": { s30: 125, s60: 76 } },
  "ファーストピラティス茨木市駅前店": { "屋宜広紀": { s30: 44, s60: 53 } },
...
// 7月:2026-07-19取得(15件 / job 225910)
CANCEL_DATA[2026][7] = [
  ...
  { store:"パーソナルジムTop Ryde 川西能勢口ANNEX店", staff:"鵜飼晃", date:"7/17", time:"11:30", name:"近間 海帆", dur:60, cxlAt:"7/17 12:25" },
  { store:"パーソナルジムTop Ryde 阪急池田店", staff:"田口美紀", date:"7/17", time:"21:00", name:"久積彩香", dur:60, cxlAt:"7/17 21:08" },
  { store:"パーソナルジムTop Ryde 川西能勢口ANNEX店", staff:"鵜飼晃", date:"7/18", time:"11:30", name:"眞田颯", dur:30, cxlAt:"7/18 12:00" }
];
...
// 2026-07-19 更新（6月受講済み顧客のうち7月に受講済み/予約中がある顧客 / job 225910,221923）
RETENTION_DATA[2026][7] = {
  "鵜飼晃":{num:34,den:38}, "空中泰樹":{num:5,den:6}, "田口美紀":{num:20,den:25}, "矢野利佳":{num:41,den:43},
  "芦田崚馬":{num:26,den:29}, "壹岐和恵":{num:41,den:44}, "屋宜広紀":{num:19,den:22}, "長濱心花音":{num:30,den:31}
};
var CONVERSION_DATA = {
...
// 2026-07-19 更新（job 225910 / 7月確定分・カウンセリング除く）
RATE_DATA[2026][7] = {
  "鵜飼晃":{done:99,daycxl:8,cxl:3}, "空中泰樹":{done:12,daycxl:0,cxl:8}, "田口美紀":{done:52,daycxl:1,cxl:20}, "矢野利佳":{done:101,daycxl:2,cxl:17},
  "芦田崚馬":{done:66,daycxl:3,cxl:8}, "壹岐和恵":{done:101,daycxl:1,cxl:30}, "屋宜広紀":{done:55,daycxl:0,cxl:7}, "長濱心花音":{done:77,daycxl:0,cxl:33}
};
...
// 2026-07-19 更新（job 225910 / 実施=受講済み 7月分）
UTIL_DATA[2026][7] = {
  "鵜飼晃":{hours:76,workdays:16}, "空中泰樹":{hours:12,workdays:8}, "田口美紀":{hours:46.5,workdays:15}, "矢野利佳":{hours:89.5,workdays:15},
  "芦田崚馬":{hours:55,workdays:14}, "壹岐和恵":{hours:68.5,workdays:12}, "屋宜広紀":{hours:43.5,workdays:16}, "長濱心花音":{hours:53,workdays:13}
};
