...
// === 2026年6月（2026-06-29 全量更新 / job id=197615（当月）+197616（前月5月・継続率突合）） ===
// 集計（対象8名）: 30分:465 / 60分:529 / 合計:994
// 【除外】キャンセル:153件（当日24含む / 通常129 / カウンセリング除く） / カウンセリング:32件（全社）
//   対象外スタッフ:54件（正規化スタッフ名が対象8名に不一致 / 担当者空欄・自主トレ等）
//   整合性: 分類994 + 対象外54 + キャンセル153 + カウンセリング32 = 1233行 = CSVデータ行数 ✓
// 【注記】月末29日時点の集計（予約中=月末までの未来分を含む）。term_type=action。
SESSION_DATA[2026] = SESSION_DATA[2026] || {};
SESSION_DATA[2026][6] = {
  "パーソナルジムTop Ryde 川西能勢口ANNEX店": {
    "鵜飼晃": { s30: 83, s60: 71 }
