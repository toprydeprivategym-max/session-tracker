...
// === 2026年7月（2026-07-11 自動更新 / job id=213379 / 予約中+受講済み＝当月進行中のため予定含む / 対象8名） ===
// 集計（対象8名・予約中+受講済み）: 30分:440 / 60分:562 / 合計:1002
// 整合性: 対象8名(受講済み+予約中+当日CXL+通常CXL)=targetRows1106 + カウンセリング11 + 担当者空欄17 = 1134行 = CSVデータ行数 ✓
// 【注記】タスク定義の対象8名（空中泰樹=川西能勢口店を含む）で集計。島村卓也は当月0本のため除外。RATE/UTIL/RETENTION/当日CXLは受講済み・確定分（7/1〜7/11）基準。予約中(未来分720件)はSESSION本数に含むがRATE/UTILには含めない。
SESSION_DATA[2026] = SESSION_DATA[2026] || {};
SESSION_DATA[2026][7] = {
  "パーソナルジムTop Ryde 川西能勢口ANNEX店": { "鵜飼晃": { s30: 86, s60: 91 } },
  "パーソナルジムTop Ryde 川西能勢口店": { "空中泰樹": { s30: 4, s60: 16 } },
  "パーソナルジムTop Ryde 阪急池田店": { "田口美紀": { s30: 14, s60: 73 } },
  "パーソナルジムTop Ryde 茨木市駅前店": { "矢野利佳": { s30: 49, s60: 133 } },
  "パーソナルジムTop Ryde 阪神西宮店": { "芦田崚馬": { s30: 34, s60: 83 } },
  "ファーストピラティス池田店": { "壹岐和恵": { s30: 114, s60: 69 } },
  "ファーストピラティス茨木市駅前店": { "屋宜広紀": { s30: 43, s60: 52 } },
  "ファーストピラティス中百舌鳥店": { "長濱心花音": { s30: 96, s60: 45 } }
};
...
// 2026-07-11 更新（6月受講済み顧客のうち7月に受講済み/予約中がある顧客 / job 213379,213376）
RETENTION_DATA[2026][7] = {
  "鵜飼晃":{num:34,den:38}, "空中泰樹":{num:5,den:6}, "田口美紀":{num:20,den:25}, "矢野利佳":{num:41,den:43},
  "芦田崚馬":{num:26,den:29}, "壹岐和恵":{num:40,den:44}, "屋宜広紀":{num:18,den:22}, "長濱心花音":{num:30,den:31}
};
var CONVERSION_DATA = {
...
// 2026-07-11 更新（job 213379 / 7/1〜7/11の確定分）
RATE_DATA[2026][7] = {
  "鵜飼晃":{done:53,daycxl:3,cxl:1}, "空中泰樹":{done:5,daycxl:0,cxl:7}, "田口美紀":{done:28,daycxl:0,cxl:14}, "矢野利佳":{done:52,daycxl:0,cxl:16},
  "芦田崚馬":{done:38,daycxl:3,cxl:6}, "壹岐和恵":{done:41,daycxl:1,cxl:22}, "屋宜広紀":{done:32,daycxl:0,cxl:3}, "長濱心花音":{done:35,daycxl:0,cxl:28}
};
...
// 2026-07-11 更新（job 213379 / 実施=受講済み 7/1〜7/11分）
UTIL_DATA[2026][7] = {
  "鵜飼晃":{hours:38.5,workdays:9}, "空中泰樹":{hours:5,workdays:4}, "田口美紀":{hours:25.5,workdays:8}, "矢野利佳":{hours:46,workdays:8},
  "芦田崚馬":{hours:32,workdays:8}, "壹岐和恵":{hours:27.5,workdays:5}, "屋宜広紀":{hours:26,workdays:9}, "長濱心花音":{hours:25,workdays:7}
};
